...
/*
 * Preface:
 * Some of the code in Sphere::check_collision is based off of Martin Horch's code file "sphere.cpp" which can be found here:
 ...
 * 
 * It has been modified and further expanded upon to accomodate the rest of our code.
 */
...
//cheks if this sphere is colliding with another sphere(other_s) by using pythagoras and move the new_coords so they do not collide
